...
macro(_find_SDL_ttf QUIET_OR_REQUIRED)
  find_package(SDL2_ttf ${QUIET_OR_REQUIRED})
...
if(USE_SDL1)
  # No need for SDL_ttf.
elseif(USE_SDL3)
  if(NOT DEFINED DEVILUTIONX_SYSTEM_SDL_TTF)
    find_package(SDL3_ttf QUIET CONFIG)
    if(SDL3_ttf_FOUND)
      message("-- Found SDL3_ttf")
    else()
      message("-- Suitable system SDL3_ttf package not found, will use SDL3_ttf from source")
      set(DEVILUTIONX_SYSTEM_SDL_TTF OFF)
    endif()
  endif()
  dependency_options("SDL3_ttf" DEVILUTIONX_SYSTEM_SDL_TTF ON DEVILUTIONX_STATIC_SDL_TTF)
  if(DEVILUTIONX_SYSTEM_SDL_TTF)
    find_package(SDL3_ttf REQUIRED CONFIG)
  else()
    # Must be the same, see:
    # https://github.com/libsdl-org/SDL_ttf/blob/main/CMakeLists.txt
    set(DEVILUTIONX_STATIC_SDL_TTF ${DEVILUTIONX_STATIC_SDL3})
    add_subdirectory(3rdParty/SDL3_ttf)
  endif()
else()
  if(EMSCRIPTEN)
    emscripten_system_library("SDL_ttf" SDL2::SDL2_ttf USE_SDL_TTF=2)
  else()
    if(NOT DEFINED DEVILUTIONX_SYSTEM_SDL_TTF)
      _find_SDL_ttf(QUIET)
      if(SDL_ttf_FOUND)
        ...
        message("-- Suitable system SDL_ttf package not found, will use SDL_ttf from source")
        set(DEVILUTIONX_SYSTEM_SDL_TTF OFF)
      endif()
    endif()
    dependency_options("SDL_ttf" DEVILUTIONX_SYSTEM_SDL_TTF ON DEVILUTIONX_STATIC_SDL_TTF)
    if(DEVILUTIONX_SYSTEM_SDL_TTF)
      _find_SDL_ttf(REQUIRED)
      if(NOT TARGET SDL2::SDL2_ttf)
        if(TARGET SDL2_ttf::SDL2_ttf)
          add_library(SDL2::SDL2_ttf ALIAS SDL2_ttf::SDL2_ttf)
        endif()
      endif()
    else()
...
if(USE_SDL3)
  target_link_libraries(DevilutionX::SDL INTERFACE SDL3_ttf::SDL3_ttf)
elseif(NOT USE_SDL1)
  target_link_libraries(DevilutionX::SDL INTERFACE SDL2::SDL2_ttf)
endif()
